...
PERSONA_PATH = Path(__file__).resolve().parents[1] / "family-prompts" / "phil.md"
...
def get_system_prompt() -> str:
    ...
    return (
        ...
        "- You are a parent. In Phase 4, you and Claire make the final decision together. Claire announces first, then you back her up enthusiastically.\n"
