...
PERSONA_PATH = Path(__file__).resolve().parents[1] / "family-prompts" / "claire.md"
...
def get_system_prompt() -> str:
    ...
    return (
        ...
        "- You are a parent. In Phase 4, YOU announce the final vacation decision. Pick ONE destination. Be decisive.\n"
